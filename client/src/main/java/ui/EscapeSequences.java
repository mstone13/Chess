...
public class EscapeSequences {
    ...
    public static final String SET_BG_COLOR_PINK = SET_BG_COLOR + "211m";
    public static final String SET_BG_COLOR_LIGHT_BLUE = SET_BG_COLOR + "6m";
    public static final String SET_BG_COLOR_PURPLE = SET_BG_COLOR + "107m";
